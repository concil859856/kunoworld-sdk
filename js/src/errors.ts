...
export const ERROR_CODES = {
  ...
  invalid_shots: "A storyboard needs its shots, and only storyboards take shots.",
  over_budget: "The gateway's quote for this job is over maxPriceUsd, so nothing was uploaded, sealed or charged. `details` has `price_usd` and `max_price_usd`.",
  invalid_budget: "maxPriceUsd must be a finite number, zero or more.",
  quote_mismatch: "The gateway quoted different params from the job about to be sent (routing changed in between), so nothing was sent. Try again.",
